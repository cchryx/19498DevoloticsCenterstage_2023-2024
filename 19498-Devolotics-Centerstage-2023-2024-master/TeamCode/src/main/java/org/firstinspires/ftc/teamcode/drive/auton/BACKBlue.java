...
//        imu.initialize(parameters);
    ...
    public void start() {
        ...
        traj_left2 = drive.trajectoryBuilder(traj_left1.end())
                .lineToLinearHeading(new Pose2d(50.3, 42, Math.toRadians(180)))
                .build(); // backdrop

        traj_left3 = drive.trajectoryBuilder(traj_left2.end())
                .lineToLinearHeading(new Pose2d(34, 15, Math.toRadians(175)))
                .build(); // line up to stack

        traj_left4 = drive.trajectoryBuilder(traj_left3.end())
                .lineToLinearHeading(new Pose2d(-56, 19, Math.toRadians(175)))
                .build(); // stack

        traj_left104 = drive.trajectoryBuilder(traj_left4.end())
                .lineToLinearHeading(new Pose2d(-56.01, 19, Math.toRadians(175)))
                .build(); // stack

        traj_left5 = drive.trajectoryBuilder(traj_left104.end())
                .lineToLinearHeading(new Pose2d(25, 19, Math.toRadians(180)))
                .build(); // go backdrop

        traj_left6 = drive.trajectoryBuilder(traj_left5.end())
                .lineToLinearHeading(new Pose2d(48.5, 42, Math.toRadians(180)))
                .build(); // backdrop white

        traj_left7 = drive.trajectoryBuilder(traj_left6.end())
                .lineToLinearHeading(new Pose2d(39, 65, Math.toRadians(180)))
                .build();

        traj_left8 = drive.trajectoryBuilder(traj_left7.end())
                .lineToLinearHeading(new Pose2d(59, 67, Math.toRadians(180)))
                .build();
        ...
        traj_middle3 = drive.trajectoryBuilder(traj_middle2.end())
                .lineToLinearHeading(new Pose2d(34, 14, Math.toRadians(173)))
                .build(); // line up to stack

        traj_middle4 = drive.trajectoryBuilder(traj_middle3.end())
                .lineToLinearHeading(new Pose2d(-55, 22, Math.toRadians(172)))
                .build(); // stack

        traj_middle104 = drive.trajectoryBuilder(traj_middle4.end())
                .lineToLinearHeading(new Pose2d(-55.01, 22, Math.toRadians(172)))
                .build(); // stack

        traj_middle5 = drive.trajectoryBuilder(traj_middle104.end())
                .lineToLinearHeading(new Pose2d(30, 20, Math.toRadians(172)))
                .build(); // go backdrop
        ...
        traj_right2 = drive.trajectoryBuilder(traj_right1.end())
                .lineToLinearHeading(new Pose2d(49.9, 31, Math.toRadians(183)))
                .build(); // backdrop

        traj_right3 = drive.trajectoryBuilder(traj_right2.end())
                .lineToLinearHeading(new Pose2d(34, 14, Math.toRadians(176)))
                .build(); // line up to stack

        traj_right4 = drive.trajectoryBuilder(traj_right3.end())
                .lineToLinearHeading(new Pose2d(-55, 16, Math.toRadians(175)))
                .build(); // stack

        traj_right104 = drive.trajectoryBuilder(traj_right4.end())
                .lineToLinearHeading(new Pose2d(-55.01, 16, Math.toRadians(175)))
                .build(); // stack

        traj_right5 = drive.trajectoryBuilder(traj_right104.end())
                .lineToLinearHeading(new Pose2d(40, 17, Math.toRadians(186)))
                .build(); // go backdrop

        traj_right6 = drive.trajectoryBuilder(traj_right5.end())
                .lineToLinearHeading(new Pose2d(48.6, 43, Math.toRadians(188)))
                .build(); // backdrop white

        traj_right7 = drive.trajectoryBuilder(traj_right6.end())
                .lineToLinearHeading(new Pose2d(38, 67, Math.toRadians(188)))
                .build();
